...
export const AppHeaderUI: React.FC<AppHeaderUIProps> = ({ price, counter, isAuthorized }) => {
  return (
    <>
    <header className="flex py-11 px-15">
      ...
      <div className="flex items-center rounded-[15px] py-2 px-5 flex-1 border border-transparent transition-colors duration-150 has-[:focus]:border-gray-300">
      ...
      <div className="flex items-center gap-4 ml-[21px]">
        ...
        { counter ? 
                  ...
                  :
                  <Button variant='outline' className='border border-orange-400 w-[130px]'>
